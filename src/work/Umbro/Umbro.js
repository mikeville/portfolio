...
import imgOnboarding4 from './media/yg-umbro-wireframes-170817-2130--slicing-18.svg' 
                ...
                <div class="row section-title">
                  <div class="col-sm-6 col-sm-offset-3">
                    <div class="section-title__title">
                      ...
                      <h1>
                        A visual language<br></br>for soccer highlights
                      </h1>
                    </div>
                    <div class="section-title__subtitle">
                      <h4>
                        Umbro covered the World Cup with post-game recaps across their digital platforms. They paired their written analysis with this graphic system.      
                      </h4>     
                    </div>
                  </div>
                </div>
              ...
              <div class="bs-container">
                <div class="row section-title">
                  <div class="col-sm-6 col-sm-offset-3">
                    ...
                    <div class="section-title__subtitle">
                      <h4>
                        Every pass, shot, and goal of the World Cup's 64 matches in South Africa.     
                      </h4>
                    </div>
                  </div>
                </div>
